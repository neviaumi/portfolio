  ...
  return (
    (t.prototype = {
      ...
      addListener: function (t, a) {
        for (
          var n, r = this._listeners, i = t.split(/[,\s]/), s = 0, o = i.length;
          o > s;
          s++
        )
      ...
      fixPos: function (e, t) {
        var a,
          ...
          s = e.line;
        return (
          i > 0 ? ((s += i), (a = r[i].length + 1)) : (a = e.col + t),
          { line: s, col: a }
        );
      },
        ...
        e.addListener('tagstart', function (e) {
          for (
            ...
            if (
              ...
              for (
                var d, c = a.value.split(/\s+/g), f = 0, g = c.length;
                g > f;
                f++
              )
                (d = c[f]),
      ...
      e.addListener('tagstart', function (e) {
        ...
        e.addListener('tagend', function (e) {
          ...
          if (i >= 0) {
            ...
            t.error(
              'Tag must be paired, no start tag: [ ' + e.raw + ' ]',
              e.line,
              e.col,
              a,
              e.raw,
