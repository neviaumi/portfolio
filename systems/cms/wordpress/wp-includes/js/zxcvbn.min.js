        ...
        function (require, module, exports) {
          ...
          (matching = require('./matching')),
            ...
            (zxcvbn = function (e, t) {
              ...
              for (
                null == t && (t = []), g = time(), u = [], n = 0, c = t.length;
                n < c;
                n++
              )
                (i = t[n]),
              ...
              return (
                (o.feedback = feedback.get_feedback(o.score, o.sequence)), o
              );
            }),
        ...
        function (require, module, exports) {
          ...
          (frequency_lists = require('./frequency_lists')),
            ...
            (build_ranked_dict = function (e) {
              var t, n, r, i, a;
              for (i = {}, t = 1, r = 0, n = e.length; r < n; r++)
                (a = e[r]), (i[a] = t), (t += 1);
              return i;
            }),
            (RANKED_DICTIONARIES = {});
            ...
            (matching = {
              ...
              reverse_dictionary_match: function (e, t) {
                ...
                for (
                  ...
                  (r = i[a]),
                    (r.token = r.token.split('').reverse().join('')),
                    (r.reversed = !0),
                ...
                for (
                  null == t && (t = RANKED_DICTIONARIES),
                    ...
                    _ = this.enumerate_l33t_subs(
                      this.relevant_l33t_subtable(e, n),
                    ),
                    c = 0,
                    a = _.length;
              ...
              spatial_match: function (e, t) {
                ...
                for (r in t)
                  (n = t[r]),
                    this.extend(i, this.spatial_match_helper(e, n, r));
                return this.sorted(i);
              },
                ...
                for (f = [], u = 0; u < e.length - 1; )
                  for (
                    c = u + 1,
                      ...
                      g =
                        ('qwerty' !== n && 'dvorak' !== n) ||
                        !this.SHIFTED_RX.exec(e.charAt(u))
                          ? 0
                          : 1;
                    ;
              ...
              repeat_match: function (e) {
                ...
                for (
                  ...
                  s[0].length > _[0].length
                    ...
                    (o = p[0]),
                    (h = p[1]),
                    (t = scoring.most_guessable_match_sequence(
                      i,
                      this.omnimatch(i),
                    )),
                    (r = t.sequence),
                ...
                for (
                  ...
                  for (
                    ...
                    if (((L = e.slice(s, +o + 1 || 9e9)), f.exec(L))) {
                      for (
                        r = [], T = DATE_SPLITS[L.length], E = 0, c = T.length;
                        E < c;
                        E++
                      )
                        (D = T[E]),
              ...
              map_ints_to_dmy: function (e) {
                ...
                if (!(e[1] > 31 || e[1] <= 0)) {
                  for (o = 0, h = 0, p = 0, s = 0, r = e.length; s < r; s++) {
                    if (
                      ((n = e[s]),
                      (99 < n && n < DATE_MIN_YEAR) || n > DATE_MAX_YEAR)
                    )
                      return;
              ...
              map_ints_to_dm: function (e) {
                var t, n, r, i, a, s;
                for (
                  a = [e, e.slice().reverse()], i = 0, n = a.length;
                  i < n;
                  i++
                )
                  if (
          ...
          (adjacency_graphs = require('./adjacency_graphs')),
            ...
            (scoring = {
                  ...
                  S = {
                    ...
                    T = (function (t) {
                      return function (n, s) {
                        ...
                        return (
                          (S.g[_][s] = i), (S.m[_][s] = n), (S.pi[_][s] = o)
                        );
                      };
                    })(this),
                    s = (function (e) {
                    ...
                    C = (function (e) {
                      return function (e) {
                        ...
                        for (; s >= 0; )
                          (c = S.m[s][a]), u.unshift(c), (s = c.i - 1), a--;
                        return u;
                      };
                    })(this),
                    u = N = 0,
              ...
              regex_guesses: function (e) {
                ...
                switch (e.regex_name) {
                  case 'recent_year':
                    return (
                      (r = Math.abs(
                        parseInt(e.regex_match[0]) - this.REFERENCE_YEAR,
                      )),
              ...
              date_guesses: function (e) {
                ...
                return (
                  (r = Math.max(
                    Math.abs(e.year - this.REFERENCE_YEAR),
                    this.MIN_YEAR_SPACE,
                  )),
                  (t = 365 * r),
                  e.separator && (t *= 4),
              ...
              spatial_guesses: function (e) {
                ...
                for (
                  'qwerty' === (E = e.graph) || 'dvorak' === E
                    ? ((l = this.KEYBOARD_STARTING_POSITIONS),
                      (s = this.KEYBOARD_AVERAGE_DEGREE))
                    : ((l = this.KEYPAD_STARTING_POSITIONS),
                      (s = this.KEYPAD_AVERAGE_DEGREE)),
                    a = 0,
                    t = e.token.length,
                    S = e.turns,
                    u = _ = 2,
              ...
              uppercase_variations: function (e) {
                ...
                if (
                  ((c = e.token),
                  c.match(this.ALL_LOWER) || c.toLowerCase() === c)
                )
                  return 1;
                for (
                  _ = [this.START_UPPER, this.END_UPPER, this.ALL_UPPER],
                    u = 0,
                    a = _.length;
                  u < a;
                  u++
