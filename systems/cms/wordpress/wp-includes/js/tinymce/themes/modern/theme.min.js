!(function (_) {
  ...
  var e,
    ...
    I = function (e, t, n, i, r, o) {
      return (
        ...
        e &&
          (o = e({ elementRect: L(i), contentAreaRect: L(r), panelRect: o })),
        o
      );
    },
    F = function (x) {
    ...
    he = function (e) {
      return (
        !((ce.ie && !(11 <= ce.ie)) || !e.sidebars) && 0 < e.sidebars.length
      );
    },
    me = function (n) {
      return {
            ...
            items: [
              {
                ...
                items: [
                  !1 === d(t)
                    ? null
                    : { type: 'menubar', border: '0 0 1 0', items: re(t) },
                  A(t, f(t)),
                ],
              },
              he(t)
      ...
      init: function (e) {
        ...
        function a(e, t) {
          ...
          do {
            if (
              (Le.exec(''),
              (i = Le.exec(e)) && ((e = i[3]), o.push(i[1]), i[2]))
            ) {
              n = i[3];
              break;
            }
    ...
    Je = Se.extend({
      ...
      set: function (t, n) {
        var i,
          ...
          o = this.data[t];
        if (
          (n instanceof Ye && (n = n.create(this, t)), 'object' == typeof t)
        ) {
      ...
      for (r in (d || (d = l._delegates = {}), i)) {
        ...
        'wheel' !== r || Qe
          ? ('mouseenter' === r || 'mouseleave' === r
              ? l._hasMouseEnter ||
                (ye(l.getEl()).on('mouseleave', s).on('mouseover', u),
                (l._hasMouseEnter = 1))
  ...
  function ct(e, h) {
    ...
    (t = function (e) {
      ...
      (p = function (e) {
        ut(e),
          ye(x).off('mousemove touchmove', v).off('mouseup touchend', p),
          m.remove(),
          h.stop && h.stop(e);
      }),
          ...
          : ((a = n.panel =
              v.create({
                ...
                items: [
                  !1 === d(s)
                    ? null
                    : { type: 'menubar', border: '0 0 1 0', items: re(s) },
                  A(s, f(s)),
                ],
              })),
    ...
    init: function (e) {
      ...
      n._super(e),
        ...
        n.on('click', function (e) {
          ...
          (we.hasClass(e.target, t) || we.hasClass(e.target.parentNode, t)) &&
            n.close();
        }),
  ...
  var Ft,
    ...
    qn = function (e) {
      return (
        (e.nodeType !== Yn && e.nodeType !== $n) || 0 === e.childElementCount
      );
    },
    Xn =
      (Vn().browser.isIE(),
        ...
        r.on('PostRender', function () {
          r.getRoot().on('submit', function (e) {
            ...
            e.isDefaultPrevented() ||
              ...
              /^https?/.test(t) &&
                (i
                  ? j(i, t).isNone() && (ui[n] = i.slice(0, 5).concat(t))
                  : (ui[n] = [t])));
          });
        });
    },
          ...
          l.on('init nodeChange', function (e) {
            var t,
              ...
              s =
                ...
                w.each(t, function (e) {
                  i ||
                    ki(e.value).toLowerCase() !== ki(r).toLowerCase() ||
                    (i = e.value);
                }),
                i);
        ...
        return (
          e.settings.multiline &&
            ...
            (t.startMinH =
              t.h =
              t.minH =
                Math.min(t.maxH, we.getSize(e.getEl()).height))),
          t
        );
      },
      repaint: function () {
    ...
    br = Nt.extend({
      ...
      renderHtml: function () {
        ...
        return (
          ...
          ((e = we.create(i.multiline ? 'textarea' : 'input', t)).value =
            n.state.get('value')),
