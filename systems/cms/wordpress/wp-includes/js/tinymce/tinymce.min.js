...
!(function (V) {
  ...
  var le,
    fe = {
      ...
      android: m,
      contentEditable:
        !f || g || 534 <= parseInt(se.match(/AppleWebKit\/(\d*)/)[1], 10),
      transparentSrc:
  ...
  (St.attr = function (e, t) {
    ...
    var n = _e.attrHandle[t.toLowerCase()],
      r =
        n && Ze.call(_e.attrHandle, t.toLowerCase()) ? n(e, t, !Ue) : undefined;
    return r !== undefined
      ? r
      : ke.attributes || !Ue
        ? e.getAttribute(t)
  ...
  (St.uniqueSort = function (e) {
    var t,
      ...
      o = 0;
    if (
      ((Le = !ke.detectDuplicates),
      (Ie = !ke.sortStable && e.slice(0)),
      e.sort(Je),
      Le)
    ) {
      ...
      function (e, t, n, r) {
        ...
        if (((n = n || []), 1 === l.length)) {
          if (
            ...
            if (!(t = (_e.find.ID(a.matches[0].replace(Nt, Et), t) || [])[0]))
              return n;
        ...
        return (
          (c || Oe(e, l))(r, t, !Ue, n, (xt.test(e) && Ot(t.parentNode)) || t),
          n
        );
      }),
    (ke.sortStable = qe.split('').sort(Je).join('') === qe),
  ...
  var En,
    ...
    Fr = function (e) {
      return (
        (e.nodeType !== Pr && e.nodeType !== Ir) || 0 === e.childElementCount
      );
    },
    Mr = function (e, t) {
      return e.dom() === t.dom();
      ...
      getPos: function (e, t, n) {
        ...
        if (((n = n || e), t)) {
          if (
            n === e &&
            t.getBoundingClientRect &&
            'static' === kr(ar.fromDom(e), 'position')
          )
            return {
              x: (a =
                (o = t.getBoundingClientRect()).left +
  ...
  (kn = undefined),
    ...
    (function (e) {
      ...
      return (function i(a, u, s) {
        ...
        for (var l = 'function' == typeof Rn && Rn, e = 0; e < s.length; e++)
          c(s[e]);
        return c;
      })(
        {
        ...
        e &&
          ...
          ii(ci(e, ','), function (e) {
            ...
            if (
              ...
              var i = N[r];
              delete (i = ai({}, i)).removeEmptyAttrs,
  ...
  var Pi = function (t, n) {
    ...
    Yi = function (e) {
      0 === ($i(e) ? e.dom().classList : qi(e, 'class')).length &&
        Sr(e, 'class');
    },
    Gi = function (e, t) {
  ...
  var ea,
    ...
    da = function (e, n) {
      e.on('init', function () {
        e.serializer.addNodeFilter('span', function (e) {
          z(e, function (t) {
            var e;
            ((e = t), _.from(e.attributes.map[ua()]).bind(n.lookup)).each(
              function (e) {
    ...
    Sa = function (e) {
      return (
        Ea(e) && (e = e.parentNode), Na(e) && e.hasAttribute('data-mce-caret')
      );
    },
    Ta = function (e) {
    ...
    Aa = function (e) {
      ...
      return (
        ...
        (t.data.charAt(e.offset()) === xa ||
          (e.isAtStart() && Ta(t.previousSibling)))
      );
    },
    Ra = function (e) {
      var t = e.container();
    ...
    Da = function (e, t, n) {
      ...
      return (
        ...
        r.appendChild(
          ((i = V.document.createElement('br')).setAttribute(
            'data-mce-bogus',
            '1',
          ),
          i),
    ...
    Ha = function (e) {
      return (
        !Va(e) && (Ma(e) ? !za(e.parentNode) : Ua(e) || Fa(e) || ja(e) || qa(e))
      );
    },
    qa = function (e) {
      return (
        !1 ===
          ((t = e),
          jo.isElement(t) && 'true' === t.getAttribute('unselectable')) && La(e)
      );
      var t;
    },
    $a = function (e, t) {
    ...
    Ga = function (e, t) {
      ...
      return (
        e.bottom - n < t.top ||
        (!(e.top > t.bottom) && Ya(t.top - e.bottom, e, t))
      );
    },
    Ja = function (e, t) {
      return (
        e.top > t.bottom || (!(e.bottom < t.top) && Ya(t.bottom - e.top, e, t))
      );
    },
    Qa = function (e, t, n) {
    ...
    Eu = function (e) {
      var t,
        ...
        i = function (e, t) {
          ...
          0 < t &&
            (n.setStart(e, t - 1), n.setEnd(e, t), Cu(n) || o(Nu(wu(n), !1))),
            t < e.data.length &&
              (n.setStart(e, t), n.setEnd(e, t + 1), Cu(n) || o(Nu(wu(n), !0)));
        };
  ...
  var Tu,
          ...
          (r = Ht.reduce(
            ...
            ? Au(r)
              ? (function (e, t) {
                  ...
                  return (
                    Au(e) && t > e.data.length && (t = e.data.length), _u(e, t)
                  );
                })(r, parseInt(o, 10))
    ...
    $u = function (e, t) {
      ...
      if (ka(e)) {
        if (
          (jo.isText(e) && Sa(e) && (e = e.parentNode),
          (n = e.previousSibling),
          Uu(n))
        )
          return n;
    ...
    Wu = function (e, t, n) {
      ...
      var a,
        ...
        d,
        m =
          $u((a = i).startContainer, a.startOffset) ||
          $u(a.endContainer, a.endOffset);
      return m
    ...
    us = function (e) {
      if (
        (Zu(e) &&
          ka(e) &&
          (_a(e) ? e.removeAttribute('data-mce-caret') : ts(e)),
        es(e))
      ) {
        var t = wa(
          (function (e) {
    ...
    ss = {
      removeAndReposition: function (e, t) {
        return _u.isTextPosition(t)
          ? as(e, t)
          : ((n = e),
            (r = t).container() === n.parentNode ? is(n, r) : os(n, r));
        var n, r;
      },
      remove: us,
    },
    ...
    ds = function (a, u, e) {
      ...
      return {
        show: function (t, e) {
          var n, r, o;
          if ((l(), (o = e), jo.isElement(o) && /^(TD|TH)$/i.test(o.tagName)))
            return null;
          if (!u(e))
            return (
              (s = (function (e, t) {
                var n, r, o;
                if (
                  ((r = e.ownerDocument.createTextNode(xa)),
                  (o = e.parentNode),
                  t)
                ) {
  ...
  var Ms,
    ...
    Ys = function (e, t) {
      if (xs(e)) {
        if ($s(t.previousSibling) && !Vs(t.previousSibling))
          return _u.before(t);
    ...
    Gs = function (e, t, n) {
      ...
      if (t.isEqual(_u.after(n)) && n.lastChild) {
        if (
          ((u = _u.after(n.lastChild)),
          ws(e) && $s(n.lastChild) && Hs(n.lastChild))
        )
    ...
    tc = function (e, t, n) {
      return e
        ? !ec(t, n) &&
            ((r = t), !(!_u.isTextPosition(r) && jo.isBr(r.getNode()))) &&
            Zs(t) &&
            Qs(n)
        : !ec(n, t) && Qs(t) && Zs(n);
      var r;
        ...
        : u
          ? Ha(u)
            ? _.some(
                e
                  ? _u.before(u)
                  : ((a = u), jo.isBr(a) ? _u.before(a) : _u.after(a)),
              )
            : ((r = t),
              (o = u),
              (i = (n = e) ? _u.before(o) : _u.after(o)),
              nc(n, r, i))
          : _.none();
    },
    ac = d(nc, !0),
    ...
    Oc = function (t, e, n, r) {
      ...
      if ((o && e[0].wrapper && (o = Ec(i, o, 'ul,ol').reverse()[0] || o), !o))
        for (
          o = n;
          o[r] && !i.isBlock(o[r]) && ((o = o[r]), !wc.isEq(o, 'br'));
    ...
    Pc = function (e, t, n, r) {
      ...
      return (
        ...
        t.collapsed &&
          ((o = Rc(c, e.getBody(), i, a, !0, r)) &&
            ((i = o.container), (a = o.offset)),
          (o = Rc(c, e.getBody(), u, s, !1, r)) &&
        ...
        n[0].selector &&
          !1 !== n[0].expand &&
          !n[0].inline &&
          ((i = Dc(c, n, t, i, 'previousSibling')),
          (u = Dc(c, n, t, u, 'nextSibling'))),
    ...
    Fc =
      ...
      (zs = 'text'),
      {
        get: function (e) {
          if (!Ms(e))
            throw new Error(
              'Can only get ' + zs + ' value of a ' + zs + ' node',
            );
          return Us(e).getOr('');
        },
        ...
        set: function (e, t) {
          if (!Ms(e))
            throw new Error(
              'Can only set raw ' + zs + ' value of a ' + zs + ' node',
            );
          e.dom().nodeValue = t;
        },
      }),
  ...
  var qc = function (e) {
    ...
    Wc = function (e) {
      return 0 < e.length && (!(t = e[e.length - 1]).firstChild || $c(t))
        ? e.slice(0, -1)
        : e;
      var t;
    },
    ...
    tl = function (e) {
      var t = Qi(e, 'br'),
        n = U(
          (function (e) {
            for (var t = [], n = e.dom(); n; )
              t.push(ar.fromDom(n)), (n = n.lastChild);
            return t;
          })(e).slice(-1),
          wo,
        );
  ...
  var ul,
    ...
    dl = function (e, t, n) {
      ...
      if (
        ...
        if (
          ((u = r.parse(t, k)), !0 === n.paste && Gc(e.schema, u) && Qc(p, i))
        )
          return (
        ...
        !(function (e, t) {
          ...
          _.from(S.getParent(T, 'td,th')).map(ar.fromDom).each(rl),
          e.fire('SetContent', s),
          e.addVisual();
      }
    },
      ...
      findRootInline: function (e, t, n) {
        var r,
          ...
          a =
            ...
            (o = t),
            (i = n),
            U(Si.DOM.getParents(i.container(), '*', o), r));
        return _.from(a[a.length - 1]);
      },
      isRtl: function (e) {
        return (
          'rtl' === Si.DOM.getStyle(e, 'direction', !0) ||
          ((t = e.textContent), gl.test(t))
        );
        var t;
      },
      isAtZwsp: function (e) {
    ...
    Kl = function (e, t) {
      return (
        ...
        ((n = t),
        jo.isElement(n) && 'A' === n.nodeName && n.hasAttribute('name')) ||
        Xl(t)
      );
      var n, r, o;
    },
      ...
      return ru(t, n, Zl).filter(function (e) {
        return (
          ...
          Vr((n = e).from().block())
            ...
            .isSome() &&
          ((t = e),
          !1 === jo.isContentEditableFalse(t.from().block().dom()) &&
            !1 === jo.isContentEditableFalse(t.to().block().dom()))
        );
        var t, n, r;
      });
    },
    ...
    gf = function (e, t, n) {
      return (
        mf(!0, t), mf(!1, n), df(t, n).fold(d(ff, e, t, n), d(lf, e, t, n))
      );
    },
    pf = function (e, t, n, r) {
    ...
    yf = function (e, t) {
      ...
      return (
        !(vf((n = e), (r = t).startContainer) || vf(n, r.endContainer)) &&
        o &&
        i
      );
    },
    bf = function (e) {
      ...
      return yf(i, a)
        ...
        : ((n = i),
          ...
          (o = r.getRng()),
          ru(
            Hl(n, ar.fromDom(o.startContainer)),
            Hl(n, ar.fromDom(o.endContainer)),
            function (e, t) {
              return (
                !1 === Mr(e, t) &&
                (o.deleteContents(),
    ...
    Sf = function (e, t) {
      return (
        ((n = t), _.from(n.getNode(!0)).map(ar.fromDom)).exists(wo) ||
        Nf(!1, e, t).isSome()
      );
      var n;
    },
    ...
    Kf = function (e, t) {
      return (
        ...
        (o = (n = t).container()),
        (i = n.offset()),
        !1 === _u.isTextPosition(n) &&
        o === r.parentNode &&
        i > _u.before(r).offset()
    ...
    Xf = function (e) {
      return Ha(e.previousSibling)
        ? _.some(
            ((t = e.previousSibling),
            jo.isText(t) ? _u(t, t.data.length) : _u.after(t)),
          )
        : e.previousSibling
    ...
    ud = function (e) {
      var t,
        n = (function (e, t) {
          for (; t && t !== e; ) {
            if (jo.isContentEditableTrue(t) || jo.isContentEditableFalse(t))
              return t;
            t = t.parentNode;
          }
          return null;
      ...
      return e
        ? (function (e) {
            if (sd(e.previousSibling))
              return (
                ld(e.previousSibling) || e.previousSibling.appendData(xa),
                e.previousSibling
              );
        ...
        : (function (e) {
            if (sd(e.nextSibling))
              return (
                cd(e.nextSibling) || e.nextSibling.insertData(0, xa),
                e.nextSibling
              );
    ...
    Od = function (n, e, r, t, o, i) {
      return ru(
        Vl.findRootInline(e, r, t),
        Vl.findRootInline(e, r, o),
        function (e, t) {
          return e !== t && Vl.hasSameParentBlock(r, e, t)
            ? bd.after(n ? e : t)
            : i;
        },
      ).getOr(i);
    ...
    fm = function (n) {
      return ((r = n),
      ru(
        lm(r.cells(), r.rng().start()),
        lm(r.cells(), r.rng().end()),
        function (e, t) {
        ...
        if ('undefined' == typeof c.length) {
          for (a in c)
            if (c.hasOwnProperty(a)) {
              ...
              if (
                (!o || n.exact) &&
                !Om(u, wc.normalizeStyleValue(e, wc.replaceVars(c[a], i), a))
              )
                return;
            }
        } else
    ...
    Mm = {
      ...
      match: function (e, t, n, r) {
        ...
        return r
          ...
          : ((r = e.selection.getNode()),
            !!Pm(e, r, t, n) ||
              !((o = e.selection.getStart()) === r || !Pm(e, o, t, n)));
      },
    ...
    Wm = function (e, t, n) {
      ...
      if (Hm(t)) rd(e, !1, ar.fromDom(t), n);
        ...
        var a = i.getRng(),
          ...
          s =
            ((r = qm(t)) && r.nodeValue.charAt(0) === jm && r.deleteData(0, 1),
            r);
        a.startContainer === s &&
          0 < a.startOffset &&
    ...
    bg = function (o) {
      return function (r, e) {
        return _.from(e)
          ...
          .filter(dr)
          .bind(function (e) {
            return yg(o, r, e.dom()).or(
              ((t = o), (n = e.dom()), _.from(Si.DOM.getStyle(n, t, !0))),
            );
            var t, n;
          })
          .getOr('');
    ...
    Ag = function (e, t, n, r, o) {
      ...
      for (i = new go(o, u); (s = i[r ? 'prev' : 'next']()); ) {
        ...
        if (jo.isText(s) && 0 < s.nodeValue.length)
          return !1 === Tg(s, f, 'A')
            ? _.some(Su(s, r ? s.nodeValue.length : 0))
            : _.none();
    ...
    Pg = function (e, t) {
      ...
      'LI' !== d || m || (l = f),
        s &&
          ...
          ((function (e, t, n) {
            for (
              var r, o = new go(t, n), i = e.getNonEmptyElements();
              (r = o.next());
    ...
    ep = function (e) {
      ...
      return (t && 0 !== t.rangeCount ? _.from(t.getRangeAt(0)) : _.none()).map(
        Zg,
      );
    },
    tp = function (e) {
    ...
    op = function (e) {
      return (e.bookmark ? e.bookmark : _.none())
        .bind(d(np, ar.fromDom(e.getBody())))
        .bind(rp);
    },
    ip = function (e) {
  ...
  function pp(s) {
    ...
    e({
      ...
      FontName: function (e, t, n) {
        var r, o;
        (o = n),
          (r = s).formatter.toggle('fontname', { value: Ng(r, o) }),
          r.nodeChanged();
      },
      FontSize: function (e, t, n) {
        var r, o;
        (o = n),
          (r = s).formatter.toggle('fontsize', { value: Ng(r, o) }),
          r.nodeChanged();
      },
      ...
      return 'selectionchange' === t
        ...
        : !e.inline &&
          ...
          : e.settings.event_root
            ? (e.eventRoot ||
                (e.eventRoot = Op.select(e.settings.event_root)[0]),
              e.eventRoot)
            : e.getBody();
    },
    Pp = function (e, t, n) {
        ...
        v = Xt.extend(
            ...
            : {}),
          {
            ...
            external_plugins:
              ...
              a && a.external_plugins
                ? Xt.extend({}, a.external_plugins, s)
                : s),
          },
        );
      return qp(e, h, n, v);
  ...
  function Qp(i) {
    var a = {},
          ...
          e in Jp
            ...
            : /^[0-9]{2,}$/.test(e)
              ...
              : ((r.charCode = e.charCodeAt(0)),
                (r.keyCode = Gp[e] || e.toUpperCase().charCodeAt(0)));
        }),
        (t = [r.keyCode]),
        Jp))
          r[n] ? t.push(n) : (r[n] = !1);
      ...
      s = function (e, t, n, r) {
        var o;
        return (
          ((o = Xt.map(Yp(e, '>'), u))[o.length - 1] = Xt.extend(
            o[o.length - 1],
            { func: n, scope: r || i },
          )),
  ...
  var Zp = function (e) {
    ...
    th = function (t, e) {
      return ((n = e),
      n.collapsed
        ? _.from(eu(n.startContainer, n.startOffset)).map(ar.fromDom)
        : _.none()).bind(function (e) {
    ...
    ih = function (e) {
      return e.inline
        ? oh(e)
        : (t = e).iframeElement && Zp(ar.fromDom(t.iframeElement));
      var t;
    },
    ah = function (e) {
    ...
    ph = function (e, t, n) {
      var r,
        ...
        p = e.inline
          ? g
          : ((r = g), ar.fromDom(r.dom().ownerDocument.documentElement)),
        h =
          ((o = e.inline),
          (a = t),
          (u = n),
                  ...
                  m(function (e) {
                    var t = W(e, function (e, t) {
                      ...
                      return (
                        e.status && Pl(u)
                          ? y(n, e.url)
                          : e.error && kh.uploadError(u, e.error),
  ...
  var $h = function (e, t) {
    ...
    Wh = function (e, t) {
      if (jo.isText(t)) {
        ...
        if (
          /^\s+$/.test(t.nodeValue) &&
          (!t.nextSibling || $h(e, t.nextSibling))
        )
          return !0;
      }
      return !1;
      ...
      if (
        ...
        for (
          ...
          if (
            ((w = h),
            (N = v),
            jo.isText(N) || (jo.isElement(N) && !$h(w, N) && !yc(N)))
          ) {
            if (Wh(h, v)) {
  ...
  var iv = function (o, i, a, e, u, t) {
      var n,
        ...
        r = function (e) {
          var t, n, r;
          for (
            r = ov([e]), -1 === o && (r = r.reverse()), t = 0;
            t < r.length;
            t++
          )
            if (((n = r[t]), !a(n, s))) {
              if ((0 < l.length && i(n, Ht.last(l)) && c++, (n.line = c), u(n)))
                return !0;
              l.push(n);
            }
        };
      ...
      (t = Si.DOM),
        ...
        (r = function (e) {
          ...
          if (p.dragging) {
            var g =
              ((f = p),
              { pageX: (d = Cv(h, e)).pageX - f.relX, pageY: d.pageY + 5 });
            (c = p.ghost),
              (l = h.getBody()),
        ...
        (n = e).on('drop', function (e) {
          var t =
            'undefined' != typeof e.clientX
              ...
              : null;
          (xv(t) || xv(n.dom.getContentEditableParent(t))) &&
            e.preventDefault();
        });
    },
    Av = function (t) {
                  ...
                  ? ((l = f = n.cloneNode(!0)),
                    (s = g.fire('ObjectSelected', {
                      ...
                      : ((r = oa(ar.fromDom(g.getBody()), '#' + h).fold(
                        ...
                        o.addRange(e),
                        z(
                          Qi(ar.fromDom(g.getBody()), '*[data-mce-selected]'),
                          function (e) {
          ...
          )),
        {
          ...
          showBlockCaretContainer: function (e) {
            e.hasAttribute('data-mce-caret') &&
              (Pa(e), u(s()), g.selection.scrollIntoView(e[0]));
          },
          hideFakeCaret: C,
          destroy: function () {
            o.destroy(), (p = null);
  ...
  var Mv = Fv,
    ...
    ny = function (e, t) {
      return (
        !(!e || !t) && ((r = t), Qv(e) === Qv(r) || ((n = t), Zv(e) === Zv(n)))
      );
      var n, r;
    };
  function ry(u) {
      ...
      (o = {
        ...
        undo: function () {
          ...
          return (
            ...
            0 < c &&
              ((e = l[--c]), ty(u, e, !0), d(!0), u.fire('undo', { level: e })),
            e
          );
        },
        redo: function () {
          ...
          return (
            c < l.length - 1 &&
              ((e = l[++c]), ty(u, e, !1), d(!0), u.fire('redo', { level: e })),
            e
          );
        },
        clear: function () {
      ...
      r.collapsed ||
        ...
        sy(
          uy(uy(n, t), function (e) {
            return (
              t(e.previousSibling) && -1 !== Ht.indexOf(n, e.previousSibling)
            );
          }),
          function (e) {
            var t, n;
  ...
  var cy = function (e, t) {
    ...
    gy = function (e, t, n) {
      ...
      return (
        ...
        jo.isText(r) &&
          n &&
          o >= r.nodeValue.length &&
          (r = new go(r, e.getBody()).next() || r),
        jo.isText(r) &&
          !n &&
          0 === o &&
          (r = new go(r, e.getBody()).prev() || r),
        r
      );
    },
    py = function (e, t, n, r) {
    ...
    vy = function (e, t, n, r) {
      return (
        !(t = wc.getNonWhiteSpaceSibling(t, n, r)) ||
        'BR' === t.nodeName ||
        e.isBlock(t)
      );
    },
        ...
        for (
          fy(n.styles, function (e, t) {
            (e = wc.normalizeStyleValue(b, wc.replaceVars(e, r), t)),
              ...
              (n.remove_similar || !i || dy(wc.getStyle(b, i, t), e)) &&
                b.setStyle(o, t, ''),
              (u = 1);
          }),
            u &&
      ...
      if (e)
        ...
        !u.select('td[data-mce-selected],th[data-mce-selected]').length
          ...
          : ((t = Yu.getPersistentBookmark(s.selection, !0)),
            ...
            r.moveToBookmark(t),
            m.inline &&
              Mm.match(s, c, l, r.getStart()) &&
              wc.moveStart(u, r, r.getRng()),
            s.nodeChanged());
      else {
        e = r.getNode();
        for (
    ...
    Dy = function (e, t, n, r) {
      (t.styles.color || t.styles.textDecoration) &&
        (Xt.walk(r, d(Ay, e), 'childNodes'), Ay(e, r));
    },
    Oy = function (e, t, n, r) {
      t.styles &&
  ...
  var Jy,
    ...
    rb = function (e, t) {
      ...
      t.convert_fonts_to_spans &&
        nb(e, r, Xt.explode(t.font_size_legacy_values)),
        (n = r),
  ...
  function bb(T, k) {
    ...
    var O = function (e) {
        var t, n, r;
        (n = e.name) in _ && ((r = R[n]) ? r.push(e) : (R[n] = [e])),
          (t = A.length);
        for (; t--; )
          (n = A[t].name) in e.attributes.map &&
      ...
      e = {
        ...
        getNodeFilters: function () {
          var e = [];
          for (var t in _)
            _.hasOwnProperty(t) && e.push({ name: t, callbacks: _[t] });
          return e;
        },
        filterNode: O,
        parse: function (e, a) {
          ...
          (a = a || {}),
            ...
            (D = {}),
            (l = yb(
              pb('script,style,head,html,body,title,meta,param'),
              k.getBlockElements(),
            ));
          ...
          t = Mv(
            {
              ...
              text: function (e, t) {
                ...
                f ||
                  ((e = e.replace(x, ' ')),
                  mb(d.lastChild, l) && (e = e.replace(b, ''))),
                  0 !== e.length &&
              ...
              start: function (e, t, n) {
                ...
                if ((n = h ? k.getElementRule(e) : {})) {
                  ...
                  n.paddEmpty && (lb(d) || db(k, g, y, d)) && cb(T, a, l, d),
                    (d = d.parent);
                }
              },
            },
  ...
  var Cb = function (e, t, n) {
    ...
    Nb = function (e, t, n, r, o) {
      ...
      return (
        (a = e),
        (s = c),
        !(u = o).no_events && a ? wp(a, Zy(u, { content: s })).content : s
      );
    };
  function Eb(e, t) {
    var a,
  ...
  var Tb,
                  ...
                  (t = N.get('mceResizeHandle' + e)) && N.remove(t),
                    ...
                    N.bind(t, 'mousedown', function (e) {
                      ...
                      e.stopImmediatePropagation(),
                        ...
                        N.bind(S, 'mouseup', P),
                        T !== S &&
                          (N.bind(T, 'mousemove', B), N.bind(T, 'mouseup', P)),
                        (c = N.add(
                          A,
                          'div',
                          {
    ...
    Zb = function (e, t, n) {
      ...
      if (
        ...
        if (
          ((t = (function (e, t) {
            if ('raw' !== t.format) {
              var n = e.parser.parse(
                t.content,
                ma({ isRootContent: !0, forced_root_block: !1 }, t),
              );
          ...
          var l = s;
          l.item &&
            (c.execCommand('Delete', !1, null), (l = e.selection.getRng())),
            /^\s+/.test(t)
              ? (l.pasteHTML('<span id="__mce_tmp">_</span>' + t),
    ...
    aC = function (e) {
      return (
        !(!e || !e.ownerDocument) &&
        zr(ar.fromDom(e.ownerDocument), ar.fromDom(e))
      );
    },
    uC = function (u, s, e, c) {
      var n,
        ...
        i = function (e, t) {
          ...
          if (
            (o = e) &&
            (iC(o) || (aC(o.startContainer) && aC(o.endContainer)))
          ) {
            var o,
              i = iC(e) ? e : null;
            if (i) {
              ...
              (t = m())
                ? ((r = t.startContainer),
                  ...
                  3 === r.nodeType &&
                    3 === o.nodeType &&
                    ((r =
                      r.length === i ? rC(r.nextSibling, !0) : r.parentNode),
  ...
  var sC = function (e, t) {
    ...
    cC = function (e, t, n, r) {
      for (
        ...
        f &&
        ((s = l), (c = f), (o = t === Tu.Forwards ? s.next(c) : s.prev(c)));
        ...
        if (o.isVisible()) {
          if (e(f, o)) {
            var m =
              ...
              (a = f),
              (u = o),
              jo.isBr(u.getNode(i === Tu.Forwards))
                ? Tb.Br
                : !1 === Ts(a, u)
                  ? Tb.Block
                  : Tb.Wrap);
    ...
    EC = function (r, o) {
      return function () {
        var t,
          e = o
            ? _u.fromRangeEnd(r.selection.getRng())
            : _u.fromRangeStart(r.selection.getRng()),
    ...
    ux = function (e, t, n, r, o) {
      ...
      if (n !== e.getBody()) {
        ...
        var s,
          c,
          l = o ? t(o) : i.create('BR');
        if (ax(n, r, !0) && ax(n, r, !1))
          rx(n, 'LI') ? i.insertAfter(l, ix(n)) : i.replace(l, n);
        else if (ax(n, r, !0))
          rx(n, 'LI')
            ? (i.insertAfter(l, ix(n)),
    ...
    px = function (a, e) {
      var t,
        ...
        T = function (e) {
          ...
          if (
            ((o = fx(e, s, i)),
            jo.isText(s) && (e ? 0 < o : o < s.nodeValue.length))
          )
            return !1;
                ...
                : T()
                  ...
                  : T(!0)
                    ...
                    : ((t = ((b = E),
                      ...
                      C.setStart(
                        b.startContainer,
                        fx(!0, b.startContainer, b.startOffset),
                      ),
                      C.setEnd(
                        b.endContainer,
                        fx(!1, b.endContainer, b.endOffset),
                      ),
    ...
    Wx = function (e, t) {
      return qx(t)
        ? Bf(t)
        : Bf(t) || sc.prevPosition($x(e, t).dom(), t).exists(Bf);
    },
    Kx = function (e, t) {
      return qx(t)
        ? Of(t)
        : Of(t) || sc.nextPosition($x(e, t).dom(), t).exists(Of);
    },
    Xx = function (e) {
      return Is(e)
        .bind(function (e) {
    ...
    Jx = function (e, t) {
      return (
        (n = e),
        (!Xx((r = t)) && (Ux(n, r) || Vx(n, r) || Sf(n, r) || Wx(n, r))) ||
          Gx(e, t)
      );
      var n, r;
    },
    ...
    rw = function (r, o) {
      return function (e) {
        return (
          (t = r),
          !Xx((n = e)) && (Yx(t, n) || Wx(t, n) || Kx(t, n)) ? Px(o) : Ix(o)
        );
        var t, n;
      };
    },
    ...
    iw = function (r) {
      r.on('keydown', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = r),
          (n = e),
          XC([{ keyCode: rv.SPACEBAR, action: KC(ow, t) }], n).each(
            function (e) {
              n.preventDefault();
            },
          ));
    ...
    uw = function (e, t) {
      var n,
        r =
          ((n = e),
          oa(ar.fromDom(n.getBody()), '*[data-mce-caret]').fold(
            q(null),
            function (e) {
              return e.dom();
            },
  ...
  var gw = function (e) {
    ...
    bw = function (t, e) {
      ...
      f.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        0 < t.contentStyles.length &&
          ...
          t.dom.addStyle(r)),
        ((i = t),
        i.inline ? vw.styleSheetLoader : i.dom.styleSheetLoader).loadAll(
          t.contentCSS,
          function (e) {
            yw(t);
          },
    ...
    kw = function (e) {
      ...
      return e.inline
        ? Tw(null)
        : ((t = r), (n = Nw.create('div')), Nw.insertAfter(n, t), Tw(n));
    },
    _w = function (e) {
      var t,
        n,
    ...
    Aw = function (t) {
      ...
      return (
        ...
        (u.aria_label =
          u.aria_label ||
          Nw.getAttrib(s, 'aria-label', t.getLang('aria.rich_text_area'))),
        ...
        S(o)
          ? ((n.settings.theme = Sw(o)),
            ...
            n.theme.init &&
              n.theme.init(
                n,
                Ah.urls[o] || n.documentBaseUrl.replace(/\/$/, ''),
                n.$,
              ))
          : (n.theme = {}),
        (i = t),
      ...
      if (
        ...
        0 !== r.indexOf('/') ||
          ...
          /^[\w\-]*:?\/\//.test(r) ||
            ((n = e.base_uri
              ? e.base_uri.path
              : new zw(V.document.location.href).directory),
            '' == e.base_uri.protocol
  ...
  (zw.prototype = {
    ...
    toAbsolute: function (e, t) {
      return (e = new zw(e, { base_uri: this })).getURI(
    ...
    Xw = function (e) {
      if (!e.removed) {
        ...
        r && e.save({ is_removing: !0 }),
          ...
          !e.inline &&
            r &&
            ((i = e), Ww.setStyle(i.id, 'display', i.orgDisplay)),
          Ep(e),
    ...
    (tN.prototype = {
      ...
      getContent: function (e) {
        return (
          (t = this),
          void 0 === (n = e) && (n = {}),
          _.from(t.getBody()).fold(
            q('tree' === n.format ? new sb('body', 11) : ''),
            function (e) {
              return Uw(t, n, e);
            },
          )
      ...
      getElement: function () {
        return (
          this.targetElm || (this.targetElm = Gw.get(this.id)), this.targetElm
        );
      },
      getWin: function () {
        var e;
  ...
  var nN,
    ...
    NN = function (e) {
      e !== bN &&
        (e
          ? gn(window).on('resize scroll', wN)
          : gn(window).off('resize scroll', wN),
        (bN = e));
    },
    EN = function (t) {
      var e = xN;
      ...
      return (
        ...
        oN.activeEditor === t &&
          (oN.activeEditor = 0 < xN.length ? xN[0] : null),
    ...
    (oN = {
      ...
      setup: function () {
        ...
        if (r) (e = r.base || r.baseURL), (n = r.suffix);
          ...
          for (
            var o = V.document.getElementsByTagName('script'), i = 0;
            i < o.length;
            i++
          ) {
            var a;
          ...
          !e &&
            ...
            (-1 !== (a = V.document.currentScript.src).indexOf('.min') &&
              (n = '.min'),
            (e = a.substring(0, a.lastIndexOf('/'))));
        }
      ...
      overrideDefaults: function (e) {
        var t, n;
        (t = e.base_url) &&
          ((this.baseURL = new zw(this.documentBaseURL).toAbsolute(
            t.replace(/\/+$/, ''),
          )),
          (this.baseURI = new zw(this.baseURL))),
          (n = e.suffix),
              ...
              r.types
                ? hN(r.types, function (t) {
                    Xt.each(o, function (e) {
                      return (
                        !gN.is(e, t.selector) || (n(c(e), vN({}, r, t), e), !1)
                      );
                    });
                  })
                : (Xt.each(o, function (e) {
      ...
      add: function (e) {
        ...
        return (
          CN[e.id] === e ||
            (null === t.get(e.id) &&
              ('length' !== e.id && (CN[e.id] = e), CN.push(e), xN.push(e)),
            NN(!0),
            (t.activeEditor = e),
      ...
      send: function (e) {
        ...
        if (
          ...
          if (
            ...
            (t = XN.fire('beforeSend', { xhr: t, settings: e }).xhr).send(
              e.data,
            ),
            !e.async)
          )
