              ...
              t.hasChildNodes()
                ? ((r = Math.min(r, t.childNodes.length - 1)),
                  e
                    ...
                    : R.insertAfter(n, t.childNodes[r]))
                : t.appendChild(n),
              (t = n),
              (r = 0)),
      ...
      Z(o, function (e) {
        ...
        (n = e.entries),
          ...
          (o = re(
            ...
            function (e) {
              return oe(e).map(bn).getOr(!1) ? Bn(i, e) : _n(i, e);
            },
          )),
          Z(o, function (e) {
            sn(r, e);
          ...
          (function (t, e, r) {
            ...
            return (
              v.each(a, function (e) {
                ...
                if (u.isBlock(e) || T(e))
                  return T(e) && u.remove(e), void (o = null);
                var n = e.nextSibling;
                ...
                if (n !== e.getBody())
                  if (n)
                    if (n.nodeName !== t || Zn(r)) {
                      ...
                      Kn(e.dom, n, r),
                        Gn(e.dom, e.dom.rename(n, t)),
                        e.selection.setRng(_(o));
                    } else Vn(e);
                  else Qn(e, t, r);
              })(e, r, n, t);
      },
