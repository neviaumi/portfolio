            ...
            if (c.get());
              ...
              c.set(!0),
                ...
                (u = {
                  ...
                  source2: '',
                  poster: '',
                  width: N(o, 'max-width').map($).getOr(''),
                  height: N(o, 'max-height').map($).getOr(''),
                });
            else {
              if (
          ...
          new F(function (t, e) {
            var r = function (e) {
              return (
                ...
                t({ url: i.source1, html: e.html ? e.html : o(i) })
              );
            };
        ...
        a = [
          {
            ...
            onpaste: function () {
              setTimeout(function () {
                B(n, i.toJSON()).then(ce(i, n))['catch'](ae(n));
              }, 1);
            },
            onchange: function (e) {
              var r, t;
      ...
      t.on('click keyup', function () {
        ...
        t.on('objectResized', function (e) {
          ...
          r.getAttribute('data-mce-object') &&
            ...
            r.setAttribute(
              'data-mce-html',
              escape(W(t, { width: e.width, height: e.height })),
            ));
        });
    },
    Oe = function (e) {
