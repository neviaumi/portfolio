  ...
  api = window.wpNavMenu = {
          ...
          return this.each(function () {
            ...
            $.each(parentDropdowns, function () {
              ...
              $html +=
                ...
                wp.i18n._x(
                  'No Parent',
                  'menu item without a parent in navigation menu',
                ) +
                '</option>';
              ...
              if (isPrimaryMenuItem) {
                ...
                for (let i = 1; i < totalMenuItems + 1; i++) {
                  ...
                  var itemString = wp.i18n.sprintf(
                    ...
                    wp.i18n._x(
                      '%1$s of %2$s',
                      'part of a total number of menu items',
                    ),
                    i,
                    totalMenuItems,
                  );
                ...
                itemPosition =
                  $(subItems.parents('.menu-item').get().reverse()).index(
                    menuItem,
                  ) + 1;
    ...
    changeMenuOrder: function (orderDropdown) {
      var menuItems = $('#menu-to-edit li'),
        ...
        currentItemAtPosition = $(subItems[newOrderID - 1]).closest(
          'li.menu-item',
        );
      ...
      if (menuItemCurrentPosition > menuItemNewPosition) {
        ...
        menuItem
          .detach()
          .insertBefore(menuItems.eq(menuItemNewPosition))
          .updateOrderDropdown();
      } else {
