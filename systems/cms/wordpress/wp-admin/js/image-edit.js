  ...
  var imageEdit = (window.imageEdit = {
    ...
    getTarget: function (postid) {
      ...
      if (element.length) {
        return (
          element
            .find('input[name="imgedit-target-' + postid + '"]:checked')
            .val() || 'full'
        );
      }
      ...
      img = $('<img id="image-preview-' + postid + '" alt="" />')
        .on('load', { history: data.history }, function (event) {
          ...
          if (
            ...
            $('button.imgedit-submit-btn', '#imgedit-panel-' + postid).prop(
              'disabled',
              false,
            );
          } else {
    ...
    initCrop: function (postid, image, parent) {
      ...
      t.iasapi = $image.imgAreaSelect({
        ...
        onSelectChange: function (img, c) {
          ...
          selW.val(
            Math.min(imageEdit.hold.w, imageEdit.round(c.width / sizer)),
          );
          selH.val(
            Math.min(imageEdit.hold.h, imageEdit.round(c.height / sizer)),
          );
