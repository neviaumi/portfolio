    ...
    window.inlineEditPost = {
      ...
      setBulk: function () {
          ...
          function () {
            if (categories[$(this).val()] == checkedPosts.length) {
              ...
              if (
                !$(this)
                  .parent()
                  .find('input[name="indeterminate_post_category[]"]').length
              ) {
                ...
                $(this)
                  ...
                  .attr(
                    ...
                    label.trim() +
                      ': ' +
                      wp.i18n.__('Some selected posts have this category'),
                  );
              }
            }
          },
        ...
        $('.inline-edit-save button').on('click', function () {
          $('.inline-edit-categories input[name="post_category[]"]').prop(
            'indeterminate',
            false,
          );
        });
